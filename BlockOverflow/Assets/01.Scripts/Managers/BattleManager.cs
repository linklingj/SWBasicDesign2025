...
public class BattleManager : SerializedMonoBehaviour
{
    ...
    void SpawnPlayers()
    {
        ...
        player1.SetUpgrades(playerData1.playerStats.speedIncrease, playerData1.playerStats.jumpIncrease, playerData1.playerStats.extraJumpCount, playerData1.playerStats.ultDamageIncrease);
        player2.SetUpgrades(playerData2.playerStats.speedIncrease, playerData2.playerStats.jumpIncrease, playerData2.playerStats.extraJumpCount, playerData2.playerStats.ultDamageIncrease);
