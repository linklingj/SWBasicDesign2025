...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private Transform groundCheck;     // 발밑 체크 포인트
    [SerializeField] private float groundRadius = 0.15f;
    [SerializeField] private LayerMask groundMask;
    [SerializeField] private float coyoteTime = 0.1f;   // 코요테 타임
    [SerializeField] private float jumpBuffer = 0.1f;   // 점프 버퍼

    [Header("Shoot")]
    [SerializeField] private Transform firePoint;       // 총구 위치
    [SerializeField] private Rigidbody2D bulletPrefab;  // 리지드바디 달린 탄환 프리팹
